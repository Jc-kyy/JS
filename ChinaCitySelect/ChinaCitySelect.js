var city_data = {
    ...
    "河北省": {
        ...
        "唐山市": ["路南区", "路北区", "古冶区", "开平区", "丰南区", "丰润区", "滦县", "滦南县", "乐亭县", "迁西县", "玉田县", "曹妃甸区", "遵化市", "迁安市"],
    ...
    "江苏省": {
        ...
        "苏州市": ["姑苏区", "虎丘区", "吴中区", "相城区", "常熟市", "张家港市", "昆山市", "吴江区", "太仓市"],
    ...
    "海南省": {
        ...
        "三亚市": ["三亚市"],
        "三沙市": ["西沙群岛", "南沙群岛", "中沙群岛"],
        "省直辖": ["五指山市", "琼海市", "儋州市", "文昌市", "万宁市", "东方市", "定安县", "屯昌县", "澄迈县", "临高县", "白沙黎族自治县", "昌江黎族自治县", "乐东黎族自治县", "陵水黎族自治县", "保亭黎族苗族自治县", "琼中黎族苗族自治县"]
    },
    "重庆市": {
        "万州区": [],
        "涪陵区": [],
...
function china_city_select() {
    ...
    if ($area_container.length) {
        ...
        // 切换
        $city_container.change(function() {
            $area_container.html('<option value="">请选择</option>');

            var now_province = $province_container.val();
    ...
    console.log(result)
    $province_container.val(result[0]).change()
    $city_container.val(result[1]).change()
    $city_container.change(function(){
        $(".country").val($province_container.val()+","+$city_container.val());
    })
    $area_container.val(result[2]).change(function(){
        // console.log($province_container.val()+","+$city_container.val()+","+$area_container.val())
        $(".country").val($province_container.val()+","+$city_container.val()+","+$area_container.val());
    })
    // $(".btn").click(function(){
    //     console.log({"name":"contry","value":china_city_select()})
    //     // formData.push({"name":"list", "value":JSON.stringify($("#stockinTable").bootstrapTable('getData')
    // })
    // return $province_container.val()+","+$city_container.val()+","+$area_container.val()
